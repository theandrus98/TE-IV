...
files_noches = ['Noche1.txt','Noche2.txt', 'Noche3.txt']
...
event_data_3, t3, time_init3, time3, triggers3 = read(files_noches[2])

event_data_1 = supresion(event_data_1, t1, -50)
event_data_2=supresion(event_data_2, t2, -50)
event_data_3=supresion(event_data_3, t3, -50)
...
event_data_3, t3=nuevo_umbral(event_data_3, t3, -umbral, -umbral, -umbral, None)
...
for i in range(len(canales)):
    ...
    tiempo_electron_3, n_candidatos_3 = busqueda_segundo_minimo(event_data_3, canales[i], tiempo_minimo, -umbral)
    print('El número de segundos picos durante la segunda noche fue: ', n_candidatos_3)
    for l in range(len(tiempo_electron_3)):
        tiempo_electron_total.append(tiempo_electron_3[l])
        if i==1:
            tiempo_electron_total_3.append(tiempo_electron_3[l])
        if i==2:
            tiempo_electron_total_4.append(tiempo_electron_3[l])
